...
public class RagService {
    ...
    @Resource
    private StreamingChatLanguageModel qwenStreamChatModel;
    @Resource
...
//    private OpenAiChatModel openAiChatModel;
     ...
     * @return 返回检索增强生成的内容
     */
    public Flux<String> chatStream(String chatId,String message,String fileUrl) {
...
//            // 1. 下载文件
//            File file = FileUtil.createTempFile(FileUtil.getSuffix(fileUrl), true);
...
//            document.metadata().put("fileUrl", fileUrl);
//
//            // 3. 切片
...
//        }
        ...
        aiServices.streamingChatLanguageModel(qwenStreamChatModel);
        aiServices.chatLanguageModel(qwenChatModel);
